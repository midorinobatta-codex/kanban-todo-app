...
create policy "Allow authenticated insert" on public.tasks
for insert to authenticated
with check (true);

drop policy if exists "Allow authenticated update" on public.tasks;
create policy "Allow authenticated update" on public.tasks
for update to authenticated
using (true)
with check (true);

drop policy if exists "Allow authenticated delete" on public.tasks;
create policy "Allow authenticated delete" on public.tasks
